...
export default function SignUp() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-white text-slate-900 dark:bg-slate-950 dark:text-white px-6 transition-colors">
      ...
      <h1 className="text-3xl font-bold">Create your FlowPilot account</h1>
      <p className="mt-2 text-slate-500 dark:text-slate-400">Free forever. No credit card needed.</p>

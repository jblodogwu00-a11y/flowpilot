    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <nav className="flex items-center justify-between px-6 py-4 md:px-12">
        ...
        <div className="hidden md:flex items-center gap-4">
          <Link href="/login" className="px-4 py-2 font-semibold hover:text-blue-400">
            Log In
          </Link>
          <Link
            href="/signup"
      ...
      {menuOpen && (
        <div className="flex flex-col gap-2 px-6 pb-4 md:hidden">
          <Link href="/login" className="rounded-lg border border-slate-700 px-4 py-3 text-center font-semibold">
            Log In
          </Link>
          <Link href="/signup" className="rounded-lg bg-blue-600 px-4 py-3 text-center font-semibold">
            Get Started
          </Link>
        </div>
      )}
      ...
      <section className="flex flex-col items-center justify-center text-center px-6 py-20 md:py-32">
        ...
        <p className="mt-4 text-xl md:text-2xl text-slate-400">Marketing Automation Made Simple</p>
        <p className="mt-8 max-w-2xl text-lg md:text-xl text-slate-300">
        ...
        <div className="mt-10 flex gap-4">
          <Link href="/signup" className="rounded-lg bg-blue-600 px-8 py-4 text-lg font-semibold hover:bg-blue-500">
            Get Started
          </Link>
          <Link href="/login" className="rounded-lg border border-slate-600 px-8 py-4 text-lg font-semibold hover:bg-slate-800">
            Log In
          </Link>
        </div>
      </section>
      ...
      {/* Problem/Solution */}
      <section className="px-6 py-20 md:px-12 bg-slate-900/30">
      ...
      <section className="px-6 py-20 md:px-12 bg-slate-900/30">
        ...
        <div className="mt-16 grid gap-10 md:grid-cols-3 max-w-5xl mx-auto">
          <div className="text-center">
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-blue-600 text-xl font-bold">1</div>
          ...
          <div className="text-center">
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-blue-600 text-xl font-bold">2</div>
          ...
          <div className="text-center">
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-blue-600 text-xl font-bold">3</div>
      ...
      {/* Final CTA */}
      <section className="px-6 py-20 md:px-12 bg-slate-900/30 text-center">
        <h2 className="text-3xl md:text-4xl font-bold">Ready to simplify your marketing?</h2>
        <p className="mt-4 text-slate-400">Join FlowPilot free — no credit card needed.</p>
      ...
      {/* Footer */}
      <footer className="border-t border-slate-800 px-6 py-10 text-center text-slate-500 md:px-12">
